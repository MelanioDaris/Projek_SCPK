...
% Last Modified by GUIDE v2.5 24-May-2022 12:43:03
...
gluko = str2double(get(handles.glukosa, 'string'));
tekanan = str2double(get(handles.tekanan_darah, 'string'));
insulin = str2double(get(handles.insulin, 'string'));
bmi = str2double(get(handles.bmi, 'string'));

a = readfis('diabetes.fis');
hasil = evalfis(a, [gluko tekanan insulin bmi]);

output = num2str(hasil);
set(handles.hasil, 'String', output);
if hasil<=0.5
    set(handles.edit6, 'string', 'Tidak');
else
    set(handles.edit6, 'string', 'Ya');
end
set(handles.hasil, 'String', output);
...
function tekanan_darah_Callback(hObject, eventdata, handles)
% hObject    handle to tekanan_darah (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of tekanan_darah as text
%        str2double(get(hObject,'String')) returns contents of tekanan_darah as a double


% --- Executes during object creation, after setting all properties.
function tekanan_darah_CreateFcn(hObject, eventdata, handles)
% hObject    handle to tekanan_darah (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.glukosa,'string','');
set(handles.tekanan_darah,'string','');
